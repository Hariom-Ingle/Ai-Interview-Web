...
const PlanCard = ({ plan, price, features, isPopular, onChoosePlan }) => (
    <Card className={`flex flex-col p-6 text-center rounded-xl shadow-lg border border-blue-200 transition-all duration-300 transform hover:scale-105
        ${isPopular ? 'border-blue-600 ring-2 ring-blue-600 bg-blue-50' : 'bg-white'}`}>
        {isPopular && (
        ...
        <CardHeader className="pb-4">
            <CardTitle className={`text-3xl font-bold mb-2 ${isPopular ? 'text-blue-800' : 'text-blue-700'}`}>
                {plan}
            </CardTitle>
            <CardDescription className="text-gray-600 text-lg">
                <span className="text-4xl font-extrabold text-blue-900">${price}</span> / month
            </CardDescription>
        </CardHeader>
        <CardContent className="flex-grow flex flex-col justify-between">
            <ul className="space-y-3 text-left mb-6 text-blue-800">
            ...
            <Button
                className={`w-full py-3 text-lg font-semibold rounded-lg shadow-md
                    ${isPopular ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-blue-500 hover:bg-blue-600 text-white'}`}
        ...
        <div className="min-h-screen bg-blue-50 p-8 flex flex-col items-center">
            <div className="w-full max-w-6xl space-y-10 animate-fade-in-up">
                ...
                <div className="text-center bg-white p-8 rounded-xl shadow-xl border border-blue-100 mb-8">
                    ...
                    <p className="text-xl text-blue-600 max-w-3xl mx-auto mb-6">
                        Unlock advanced features, unlimited practice, and deeper insights to confidently land your dream job.
                    </p>
                    <Button
                        variant="outline"
                        className="text-blue-700 border-blue-300 hover:bg-blue-100 flex items-center space-x-2 rounded-lg py-2 px-6"
                ...
                <div className="text-center bg-blue-100 p-8 rounded-xl shadow-lg border border-blue-200 mt-10">
                    <h2 className="text-3xl font-bold text-blue-800 mb-4">Ready to take the next step?</h2>
                    ...
                    <Button
                        className="bg-blue-700 hover:bg-blue-800 text-white px-8 py-4 text-xl rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300"
